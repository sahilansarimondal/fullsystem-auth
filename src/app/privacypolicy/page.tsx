...
const PrivacyPolicy = () => {
  return (
    <div className="py-6 px-14 flex flex-col gap-4">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;the Company&quot;, &quot;We&quot;,
            &quot;Us&quot; or &quot;Our&quot; in this
            Agreement) refers to Sahil Ansari.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Country</strong> refers to: Telangana,
            India
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Sahil Ansari,
            accessible from{" "}
            <a
              href="https://scott.sahilansari.online"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://scott.sahilansari.online
            </a>
          </p>
        </li>
        <li>
      ...
      <p>
        ...
        Third-Party Social Media Service&#39;s account. If
        You choose to provide such information and Personal
      ...
      <p>
        ...
        party&#39;s site. We strongly advise You to review
      ...
      <ul>
        <li>By email: sahilfiver04@gmail.com</li>
      </ul>
    </div>
  );
};
